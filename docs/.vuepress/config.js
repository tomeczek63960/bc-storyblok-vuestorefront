module.exports = {
  ...
  themeConfig: {
    repo: 'https://github.com/vuestorefront/bigcommerce',
    editLinks: true,
    docsDir: 'docs',
    docsBranch: 'develop',
    ...
    nav: [
      ...
      // { text: 'Demo', link: '' },
      { text: 'GitHub', link: 'https://github.com/vuestorefront/bigcommerce'},
      { text: 'Roadmap', link: 'https://github.com/vuestorefront/bigcommerce'}
    ],
    sidebar: [
      {
        title: 'Essentials',
